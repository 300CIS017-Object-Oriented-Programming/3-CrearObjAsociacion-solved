...
Perro::Perro( std::string nombre, std::string tamanio, std::string color, int edad):
nombre(nombre), tamanio(tamanio), color(color){}

void Perro::ladrar() {
    std::cout << "Guau Guau" << " soy "<< this->nombre<<std::endl;
}
